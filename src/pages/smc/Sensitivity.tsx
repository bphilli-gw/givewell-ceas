...
import type { TornadoEntry } from '../../model/smc-types';

const PARAM_LABELS: Record<string, string> = {
  cost_per_child_reached: 'Cost per Child Reached',
  mortality_rate_under5: 'Mortality Rate (Under 5)',
  season_proportion: 'Season Proportion',
  effect_on_deaths: 'Effect on Deaths',
...
export default function SMCSensitivity() {
  ...
  const histogramData = useMemo(() => {
    if (!tornadoCountry?.monte_carlo) return null;
    const baseCE = tornadoCountry.results.final_ce;
  ...
  return (
    <div className="page sensitivity-page">
      <h1>SMC Sensitivity Analysis</h1>
          ...
          <div className="chart-container" style={{ height: 280 }}>
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={histogramData} margin={{ left: 10, right: 20, top: 10, bottom: 30 }}>
                ...
                />
                <ReferenceLine
                  x={tornadoCountry?.results.final_ce ?? 0}
                  stroke="#dc2626"
                  strokeDasharray="4 4"
